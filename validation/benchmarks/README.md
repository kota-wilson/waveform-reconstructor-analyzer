...
The script writes generated CSV/config files under `target/ferrisoxide-signal-benchmark/`, then runs the dependency-free `ferrisoxide-signal-bench` helper to report average read, parse, transform, criteria, report, and total timings.
