...
Expected deliverable: Validate the M9-008 branch, open the issue #84 PR, wait for protected CI, and merge only after required checks pass.
...
- Next gate: Validate M9-008 locally, open the M9-008 PR, and complete protected CI.
