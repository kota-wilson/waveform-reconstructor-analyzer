...
Role: Test Automation Engineer / GitHub Maintainer Specialist

Expected deliverable: Validate the M9-010 branch, open the issue #86 PR, wait for protected CI, merge only after required checks pass, verify issue #86 closure, and close milestone #9 if no open issues remain.
...
- Next gate: Validate M9-010 locally, open the M9-010 PR, complete protected CI, and close milestone #9 after issue #86 closes.
