...
Expected deliverable: Validate the M9-009 branch, open the issue #85 PR, wait for protected CI, and merge only after required checks pass.
...
- Next gate: Validate M9-009 locally, open the M9-009 PR, and complete protected CI.
