...
Implement and validate the M37-M42 desktop user workflow path after the M25-M36 comprehensive filter and signal-conditioning suite reached `main`.
...
M36 is complete through catalog, UX, compatibility, validation-corpus, benchmark-readiness, release-readiness, community, retrospective, stale-reference closure artifacts, and PR #175 mainline merge evidence. M37-M42 are implemented locally as the desktop workflow path with source intake/inspect, channel labeling/config scaffolding, transform/criteria authoring templates, evaluation bundles, and workflow validation corpus coverage. No GitHub milestones/issues for M15-M42, dependency changes, live DAQ, GUI, HAL/RTOS, hardware, certification work, release tag, crate publication, or public announcement were added by this update.

## Current Stage

The M10-M36 sequence is complete through the approved runtime-path follow-up, the full comprehensive conditioning suite, and PR #175 mainline merge. `docs/next-milestones-roadmap.md` defines the historical sequence and now records M37-M42 as the implemented local desktop workflow path. `docs/v0.8.0-transform-architecture-milestone-proposal.md` covers WRA-RQ-070 through WRA-RQ-074, `docs/v0.9.0-pointwise-windowed-transform-mvp-milestone-proposal.md` covers WRA-RQ-075 through WRA-RQ-080, `docs/v0.10.0-event-validation-transform-milestone-proposal.md` covers WRA-RQ-081 through WRA-RQ-086, `docs/v0.11.0-transform-runtime-profile-validation-milestone-proposal.md` covers WRA-RQ-087 through WRA-RQ-092, `docs/v0.12.0-high-pass-baseline-correction-milestone-proposal.md` covers WRA-RQ-093 through WRA-RQ-098, M15-M20 docs cover WRA-RQ-099 through WRA-RQ-105, M21-M24 docs cover WRA-RQ-106 through WRA-RQ-109, M25 docs cover WRA-RQ-110, `docs/comprehensive-filter-signal-conditioning-roadmap.md` covers WRA-RQ-111 through WRA-RQ-121, and `docs/desktop-user-workflow-roadmap.md` covers WRA-RQ-122 through WRA-RQ-127. GitHub milestone #10 is closed with M10-001 through M10-006 as closed issues #132 through #137 and merged PR #138. GitHub milestone #11 is closed with M11-001 through M11-007 as closed issues #140 through #146 and merged PR #147. GitHub milestone #12 is closed with M12-001 through M12-007 as closed issues #149 through #155 and merged PR #156. GitHub milestone #13 is closed with M13-001 through M13-006 as closed issues #158 through #163 and merged PR #164; PR #165 records release/community closure artifacts and PR #166 records explicit M13 V&V/QA gates. GitHub milestone #14 is closed with M14-001 through M14-006 as closed issues #167 through #172 closed by PR #173. M15-M36 are complete and merged through PR #175 without GitHub issue creation. The remaining local slice is final M42 validation evidence and merge-ready handoff for source inspection, channel/config scaffolding, authoring templates, evaluation bundles, docs, and examples. Release publication, runtime-loader implementation, live/realtime DAQ, GUI, hardware/runtime work, dependency changes, or new scope remain separately gated.
...
- Risk: Desktop workflow CLI implementation may be mistaken for GUI, live DAQ, realtime hardware acquisition, runtime loader, or certification implementation.
...
- Current milestone: M37-M42 desktop workflow is implemented and validated locally after M36 comprehensive conditioning closure merged through PR #175. M38 source inspection, M39 channel/config scaffolding, M40 authoring templates, M41 evaluation bundles, and M42 workflow docs/examples are ready for merge through the standard process. Milestone #14, `v0.12.0: High-Pass Baseline Correction`, is closed with issues #167 through #172 closed by PR #173. Milestone #13, `v0.11.0: Transform Runtime Profile Validation`, is closed with issues #158 through #163 closed by PR #164. Milestone #12, `v0.10.0: Event And Validation Transform MVP`, is closed with issues #149 through #155 closed by PR #156. M7, M8, M9, M10, M11, M15, M16, M17, M18, M19, M20, M21, M22, M23, M24, M25, M26, M27, M28, M29, M30, M31, M32, M33, M34, M35, and M36 are closed; TEST-001, DOCS-001, BRAND-002, and REPO-001 are complete. M15-M42 have no GitHub milestones/issues by design for this pass.
...
- Next gate: Standard merge review for the validated M37-M42 desktop workflow; dependency review is required before adding third-party crates, and release publication, runtime-loader implementation, live DAQ SDKs, GUI, HAL/RTOS adapters, cryptographic signing, hardware/certification evidence, or new scope remain separately gated.
...
- Verification matrix: `traceability-matrix.md` updated with implemented evidence through WRA-RQ-127. Milestones #9, #10, #11, #12, #13, and #14 are closed in GitHub; M15-M36 are complete and merged through PR #175; M37-M42 are implemented locally.
...
| M37 Desktop User Workflow Roadmap Gate | Pass locally | `docs/desktop-user-workflow-roadmap.md`; README; requirements WRA-RQ-122 through WRA-RQ-127; traceability, risk, orchestration, and project-state updates define the workflow path while keeping live/realtime DAQ, GUI, runtime, hardware, dependency, release, and certification work gated | Product Architect / Project Coordinator |
| M38-M42 Desktop Workflow Implementation Gate | Pass locally | `crates/ferrisoxide-cli/src/main.rs`; `docs/desktop-user-workflow.md`; README; `examples/m42-desktop-workflow-waveform.csv`; `examples/m42-desktop-workflow-config.toml`; focused desktop workflow CLI tests, M42 fixture smokes, workspace tests, clippy, link scan, whitespace scan, and diff check cover source inspection, realtime rejection, config scaffolding, authoring templates, CSV bundles, and simulation bundles | V&V Engineer / Documentation Engineer |
