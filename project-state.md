...
Expected deliverable: Validate the M9-007 branch, open the issue #83 PR, wait for protected CI, and merge only after required checks pass.
...
- Next gate: Validate M9-007 locally, open the M9-007 PR, and complete protected CI.
