...
Expected deliverable: Open the TEST-001 PR, wait for protected CI, and merge only after required checks pass.
...
- Next gate: Complete TEST-001 PR creation and protected CI.
