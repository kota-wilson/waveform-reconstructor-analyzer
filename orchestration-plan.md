...
| WRA-TASK-080 | Record major crate architecture documentation rule | Documentation Engineer / Software Architect | User documentation-rule recommendation | `docs/architecture.md` defines major crate criteria, crate-local `architecture.md` requirement, Mermaid component/data-flow diagram requirement, and existing-crate backfill boundary | Documentation Gate | Complete for rule; backfill pending |
