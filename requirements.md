...
| WRA-RQ-037 | The DSL shall use a small auditable operator vocabulary. | v0.5.0 / issue #56 | High | `less_than`, `less_than_or_equal`, `greater_than`, `greater_than_or_equal`, and `equal_to` are parsed, validated, tested, and reported. | Core Software Engineer / V&V Engineer | Planned |
| WRA-RQ-038 | The DSL shall require explicit units. | v0.5.0 / issue #56 | High | Requirement and threshold values include explicit units; missing, unsupported, or mismatched units return clear errors without panics. | Core Software Engineer / V&V Engineer | Planned |
