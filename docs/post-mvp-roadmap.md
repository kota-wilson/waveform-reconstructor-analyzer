...
- No hosted service, scheduler, database workflow, plugin runtime, full packaged GUI product, or web UI.
- No live/realtime DAQ, vendor SDK, hardware acquisition, runtime loader, release publication, or certification workflow has been implemented by the M37-M51 workflow work.
